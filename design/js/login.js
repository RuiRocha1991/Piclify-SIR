...
function verifyPasswordIsValid(){
    ...
    $.ajax({
        url:window.CONNECTION_NODE+'/validator/isPassword',
        type: "get",
...
function verifyPasswordIsEqual(){
    ...
    if(password!=passwordReview){
        ...
        $('#defaultRegisterFormPassword2HelpBlock').text('Different Password');
...
function createAccountVerifyEmail(){
    ...
    if(data){
        ...
        $.ajax({
            url:window.CONNECTION_NODE+'/user/getUserByEmail',
            type: "get",
...
function createLogin(){
    ...
    if(data){
        $.ajax({
            url:window.CONNECTION_NODE+'/user/login',
            type: "post",
